...
export declare const AUTH_REPOSITORY_PORT: unique symbol;
...
export interface AuthRepositoryPort {
    ...
    findWithPasswordByPhoneNumber(phoneNumber: string): Promise<AuthUserWithPassword | null>;
    ...
    createRefreshSession(userId: string, tokenHash: string, expiresAt: Date): Promise<unknown>;
    findActiveSessionByTokenHash(tokenHash: string): Promise<AuthRefreshSession | null>;
    revokeSessionById(sessionId: string): Promise<unknown>;
    revokeSessionByTokenHash(tokenHash: string): Promise<void>;
    rotateSessionToken(oldSessionId: string, userId: string, newTokenHash: string, expiresAt: Date): Promise<unknown>;
