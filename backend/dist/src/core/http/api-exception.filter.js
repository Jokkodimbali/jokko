...
let ApiExceptionFilter = class ApiExceptionFilter {
        ...
        const fallback = (0, app_http_exception_1.appMessage)('SYSTEM_INTERNAL_SERVER_ERROR');
        const responseObject = typeof exceptionResponse === 'object' && exceptionResponse !== null
            ? exceptionResponse
            : null;
