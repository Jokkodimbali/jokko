...
const users_repository_port_1 = require("./application/ports/users-repository.port");
...
exports.UsersModule = UsersModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [
            ...
            {
                provide: users_repository_port_1.USERS_REPOSITORY_PORT,
                useExisting: users_repository_1.UsersRepository,
            },
        ],
    })
], UsersModule);
