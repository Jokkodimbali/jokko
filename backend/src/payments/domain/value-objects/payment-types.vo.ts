...
export enum EscrowStatus {
  LOCKED = 'LOCKED', // Fonds bloqués en attente de prestation
  RELEASED = 'RELEASED', // Fonds débloqués vers le professionnel
...
export enum TransactionType {
  PAYMENT = 'PAYMENT', // Paiement client pour réservation
  ESCROW_RELEASE = 'ESCROW_RELEASE', // Déblocage fonds vers pro
