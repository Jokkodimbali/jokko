...
export class AppointmentDetailPageComponent implements AfterViewInit, OnDestroy, OnInit {
    ...
    () =>
      this.clientTravelsToProvider()
        ? this.routeActorArrivalConfirmed() ||
          this.isArrivalPinned() ||
          (this.isProviderViewer() && this.trackingIndicatesArrival(this.tracking()))
        : this.trackingIndicatesArrival(this.tracking()),
  );
  ...
  private normalizeArrivedTravelerTracking(
    ...
    if (!this.shouldAcceptTrackingArrivalFromServer() && !this.isArrivalPinned()) {
      return tracking;
    }
  ...
  private trackingIndicatesArrival(
    ...
    const isActiveTravel =
      ...
      tracking.presence.status === 'EN_ROUTE';
    if (!isActiveTravel) {
      return false;
    }
  ...
  private shouldAcceptTrackingArrivalFromServer(): boolean {
    return !this.clientTravelsToProvider() || this.isProviderViewer();
  }
  ...
  private setTrackingSafely(tracking: NonNullable<ReturnType<typeof this.tracking>>): void {
    window.setTimeout(() => {
      ...
      if (
        this.shouldAcceptTrackingArrivalFromServer() &&
  ...
  private startProviderLocationSharing(appointmentId: string): void {
    ...
    this.providerLocationSubscription = this.providerLocation
      ...
      next: (position) => {
        ...
        if (this.hasTravelerArrivedAtDestination() || this.trackingIndicatesArrival(this.tracking())) {
          this.stopProviderLocationSharing();
          return;
        }
...
<head>
  ...
  <style>
    ...
    body.invoice-document{background:#e9edf1}.sheet.invoice-sheet{border:0;border-radius:16px;box-shadow:0 22px 70px rgba(15,23,42,.12);max-width:760px;overflow:hidden;padding:0}
    .mission-invoice{background:#fff;color:#151b29}.mission-invoice__header{align-items:center;background:#9b6429;color:#fff;display:grid;grid-template-columns:1fr auto;gap:24px;padding:28px 36px}
    ...
    .medical-prescription{background:#fff;border-top:5px solid #9b6429;color:#151b29;min-height:900px;position:relative}.medical-prescription__header{align-items:start;display:grid;grid-template-columns:1fr auto;gap:32px;padding:34px 34px 24px}.medical-prescription__doctor small,.medical-prescription__patient small,.medical-prescription__section-title{color:#9b6429;display:block;font-size:11px;font-weight:900;letter-spacing:.14em;text-transform:uppercase}.medical-prescription__doctor h1{color:#111827;font-size:23px;line-height:1.1;margin:10px 0 8px;text-transform:none}.medical-prescription__doctor p,.medical-prescription__meta small,.medical-prescription__patient span,.medical-prescription__patient em{color:#728096;font-size:14px;line-height:1.35;margin:3px 0}.medical-prescription__meta{text-align:right}.medical-prescription__meta span{color:#9aa5b5;display:block;font-size:12px;font-weight:900;letter-spacing:.12em;text-transform:uppercase}.medical-prescription__meta strong{color:#445066;display:block;font-size:12px;margin:6px 0}.medical-prescription__banner{align-items:center;background:#edf5fc;display:grid;gap:14px;grid-template-columns:1fr auto 1fr;padding:22px 34px}.medical-prescription__banner:before,.medical-prescription__banner:after{background:#c8dced;content:"";height:1px}.medical-prescription__banner h2{border:0;color:#9b6429;font-size:18px;font-weight:900;letter-spacing:.28em;margin:0;padding:0;text-align:center;text-transform:uppercase}.medical-prescription__body{padding:20px 34px 170px}.medical-prescription__patient{background:#f8fbff;border:1px solid #d7e8f8;border-radius:13px;display:grid;grid-template-columns:1fr auto;gap:24px;margin-bottom:20px;padding:16px 20px}.medical-prescription__patient strong{color:#111827;display:block;font-size:15px;margin:8px 0 3px}.medical-prescription__patient em{display:block;font-style:normal;text-align:right}.medical-prescription__section-title{margin:0 0 14px}.medical-prescription__list{counter-reset:prescription;display:grid;gap:10px;margin:0;padding:0}.medical-prescription__item{align-items:center;background:#fbfdff;border:1px solid #e3edf6;border-radius:13px;counter-increment:prescription;display:grid;gap:16px;grid-template-columns:26px 1fr;line-height:1.45;list-style:none;min-height:30px;padding:13px 18px}.medical-prescription__item:before{align-items:center;background:#9b6429;border-radius:50%;color:#fff;content:counter(prescription);display:inline-flex;font-size:12px;font-weight:900;height:24px;justify-content:center;width:24px}.medical-prescription__item span{color:#445066;font-size:13px}.medical-prescription__item b{color:#344054}.medical-prescription__empty{background:#fbfdff;border:1px solid #e3edf6;border-radius:13px;color:#8b95a5;font-size:13px;margin:0;padding:14px 18px}.medical-prescription__footer{align-items:end;background:#f4f9fd;border-top:1px solid #e3edf6;bottom:0;display:grid;grid-template-columns:1fr auto;left:0;padding:36px 34px 20px;position:absolute;right:0}.medical-prescription__signature span,.medical-prescription__generated span{color:#9aa5b5;display:block;font-size:12px;margin-bottom:8px}.medical-prescription__signature strong{align-items:center;border:1px dashed #b7d7f3;border-radius:8px;color:#c7cfd9;display:flex;font-size:12px;font-weight:800;height:52px;justify-content:center;width:136px}.medical-prescription__generated{text-align:right}.medical-prescription__brand{align-items:center;background:#fff;border-radius:12px;display:inline-grid;gap:8px;grid-template-columns:26px auto;padding:7px 9px;text-align:left}.medical-prescription__brand img{height:24px;object-fit:contain;width:24px}.medical-prescription__brand b{color:#9b6429;display:block;font-size:11px;text-transform:uppercase}.medical-prescription__brand small{color:#9aa5b5;display:block;font-size:10px}
...
<body class="${body.includes('mission-invoice') || body.includes('medical-prescription') ? 'invoice-document' : ''}"><main class="sheet${body.includes('mission-invoice') || body.includes('medical-prescription') ? ' invoice-sheet' : ''}">${body}</main></body>
</html>`;
