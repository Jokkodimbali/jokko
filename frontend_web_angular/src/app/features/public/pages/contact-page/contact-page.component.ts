  ...
  protected readonly socialLinks = [
    {
      ...
      viewBox: '0 0 24 24',
      paths: [
        'M15.1 8.1h2.1V4.4c-.4-.1-1.7-.2-3.2-.2-3.2 0-5.4 2-5.4 5.7v3.2H5v4.2h3.6V24H13v-6.7h3.5l.6-4.2H13V10.3c0-1.2.3-2.2 2.1-2.2Z',
      ],
    },
    {
      label: 'Instagram',
    ...
    },
    {
      ...
      viewBox: '0 0 24 24',
      paths: [
        'M4.98 3.5A2.5 2.5 0 1 1 5 8.5a2.5 2.5 0 0 1-.02-5ZM3 9.8h4V22H3V9.8Zm6.2 0H13v1.7h.1c.5-1 1.9-2 3.9-2 4.1 0 4.9 2.7 4.9 6.2V22h-4v-5.6c0-1.3 0-3.1-1.9-3.1s-2.2 1.5-2.2 3V22h-4V9.8Z',
      ],
    },
    {
      label: 'TikTok',
      ...
      viewBox: '0 0 24 24',
      paths: [
        'M16.7 2c.3 2.5 1.8 4.3 4.3 4.5v3.6a7.5 7.5 0 0 1-4.2-1.3v6.8c0 4.1-2.8 6.4-6.1 6.4-3.5 0-6.2-2.7-6.2-6.1 0-3.9 3.4-6.8 7.3-6v3.8c-1.8-.6-3.5.7-3.5 2.3 0 1.3 1 2.4 2.4 2.4 1.5 0 2.4-.9 2.4-2.9V2h3.6Z',
      ],
    },
    {
      label: 'X',
      ...
      viewBox: '0 0 24 24',
      paths: [
        'M18.9 2h3.4l-7.4 8.5L23.6 22h-6.8l-5.3-7-6.1 7H2l7.9-9.1L1.6 2h7l4.8 6.4L18.9 2Zm-1.2 18h1.9L7.6 3.9h-2L17.7 20Z',
      ],
    },
  ];
}
